...
export default function Home() {
  return (
    <div style={{minHeight:'100vh',background:'#F0FBF7'}}>
      <nav style={{background:'white',borderBottom:'1px solid #d4ede4',padding:'0 2rem',display:'flex',alignItems:'center',justifyContent:'space-between',height:'60px',position:'sticky',top:0,zIndex:100}}>
      ...
      <div style={{maxWidth:'680px',margin:'0 auto',padding:'5rem 2rem 3rem',textAlign:'center'}}>
        ...
        <p style={{fontSize:'17px',color:'#5a7a6e',lineHeight:1.6,marginBottom:'2.5rem',maxWidth:'520px',margin:'0 auto 2.5rem'}}>
          Raddad answers every WhatsApp message automatically — in Arabic and English, 24/7. Books appointments, takes payments, follows up leads.
        </p>
        <div style={{display:'flex',gap:'12px',justifyContent:'center',marginBottom:'1rem',flexWrap:'wrap'}}>
      ...
      <div style={{maxWidth:'720px',margin:'0 auto 4rem',padding:'0 1.5rem'}}>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1rem'}}>
          <div style={{background:'white',border:'1px solid #d4ede4',borderRadius:'14px',padding:'1.25rem'}}>
      ...
      <div style={{maxWidth:'720px',margin:'0 auto 4rem',padding:'0 1.5rem'}}>
        <h2 style={{fontSize:'28px',fontWeight:600,letterSpacing:'-0.5px',textAlign:'center',marginBottom:'2rem'}}>Everything automated</h2>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))',gap:'12px'}}>
          {[
            ...
            <div key={i} style={{background:'white',border:'1px solid #d4ede4',borderRadius:'14px',padding:'1.25rem'}}>
      ...
      <div style={{maxWidth:'720px',margin:'0 auto 4rem',padding:'0 1.5rem'}}>
        <h2 style={{fontSize:'28px',fontWeight:600,letterSpacing:'-0.5px',textAlign:'center',marginBottom:'8px'}}>Simple pricing</h2>
        <p style={{color:'#5a7a6e',textAlign:'center',marginBottom:'2rem'}}>Start free. Upgrade when you see results.</p>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))',gap:'12px'}}>
          {[
